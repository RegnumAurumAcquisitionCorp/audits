...
- **FYEO**: Recommended by Chainlink, FYEO conducted the initial audit. It identified a few high-priority issues and no critical vulnerabilities.
- **Pashov Audit Group**: Conducted three audits on the fx fork for $pmUSD (RWf(x) V1, V2, and V3), plus three CORE audits covering iREET and Lending.
<!-- - **Cyfrin Codehawks**: As part of a security competition, Cyfrin Codehawks will conduct an extensive audit of all smart contracts. -->

For detailed information about the audit reports, check the links in the table above.
